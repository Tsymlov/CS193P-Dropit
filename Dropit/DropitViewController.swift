...
class DropitViewController: UIViewController, UIDynamicAnimatorDelegate {
    ...
    @IBOutlet weak var gameView: BazierPathView!
    ...
    @IBAction func grabDrop(sender: UIPanGestureRecognizer) {
        ...
        switch sender.state{
        case .Began:
            if let lastDroppedV = lastDroppedView{
                attachment = UIAttachmentBehavior(item: lastDroppedV, attachedToAnchor: gesturePoint)
            }
            lastDroppedView = nil
        case .Changed:
